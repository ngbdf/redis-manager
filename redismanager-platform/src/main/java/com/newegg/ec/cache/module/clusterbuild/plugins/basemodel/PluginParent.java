package com.newegg.ec.cache.module.clusterbuild.plugins.basemodel;
...
public abstract class PluginParent {
    ...
    protected int addCluster(JSONObject reqParam) {
        ...
        if (StringUtils.isNotEmpty(node.getIp())) {
            ...
            clusterId = clusterService.addCluster(cluster);
        }
        return clusterId;
    }

    protected int updateClusterPassword(int clusterId, String  password) {
        return clusterService.updateRedisPassword(clusterId,password);
    }
