...
/**
 * @type POST 
 * @param  com.newegg.ec.cache.app.model.RedisQueryParam@38291795
 */
...
/**
 * @type POST 
 * @param  com.newegg.ec.cache.app.model.BatchConfigParam@7f7c420c
 */
function  batchConfig(batchConfigParam,callback){
   ajax.async_post("/cluster/batchConfig",batchConfigParam,callback);
}
/**
 * @type GET 
 * @param  String
